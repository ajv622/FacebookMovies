...
import edu.galileo.android.facebookmovies.FacebookMoviesApp;
import edu.galileo.android.facebookmovies.R;
import edu.galileo.android.facebookmovies.entities.Movie;
import edu.galileo.android.facebookmovies.login.ui.LoginActivity;
...
public class MovieListActivity extends AppCompatActivity implements MovieListView, OnItemClickListener {
    ...
    public void onItemClick(Movie movie) {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(movie.getSourceURL()));
        startActivity(intent);
    }
